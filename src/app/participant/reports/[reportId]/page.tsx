...
export default async function ParticipantReportDetailPage({ params }: Props) {
  ...
  return (
    <main className="min-h-screen bg-[#f4f2ed] px-5 py-10 text-black sm:px-8"><div className="mx-auto max-w-4xl">
      ...
      <aside className="mt-8 border-t border-black py-8 text-sm leading-7 text-black/60">This release remains a governed preliminary research record. No PDF download, scoring output, or participant-facing advisory authority is provided.</aside>
    </div></main>
  );
}
