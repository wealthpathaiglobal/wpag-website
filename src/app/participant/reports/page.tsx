...
export default async function ParticipantReportsPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f4f2ed] px-5 py-10 text-black sm:px-8"><div className="mx-auto max-w-5xl">
      ...
      <aside className="border-t border-black py-8 text-sm leading-7 text-black/60">Preliminary research report only. This material does not create financial advice, diagnosis, treatment, transition, execution, Pilot, or Production authority. No official PDF is available in this sprint.</aside>
    </div></main>
  );
}
