...
type ParticipantDashboardClientProps = {
        ...
        <section className="grid gap-10 py-12 lg:grid-cols-[minmax(0,1.15fr)_minmax(320px,0.85fr)] lg:gap-16 lg:py-20">
          ...
          <aside className="border border-black bg-black p-6 text-white sm:p-8">
            ...
            <p className="mt-5 text-sm leading-7 text-white/80">
              This authenticated workspace retrieves the participant master
              record associated with the current account. Modules that remain
              prototypes are identified separately below.
            </p>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <article className="border border-black bg-black p-6 text-white sm:p-8">
                ...
                <p className="mt-4 text-sm leading-7 text-white/65">
                  Participant identifier: {participantCode}
                </p>
              </article>
          ...
          <div className="grid gap-8 lg:grid-cols-[0.7fr_1.3fr] lg:gap-16">
            ...
            <div className="border border-black/25 px-6 sm:px-8">
              ...
              <StatusRow
                ...
                value="Participant record loaded"
              />
