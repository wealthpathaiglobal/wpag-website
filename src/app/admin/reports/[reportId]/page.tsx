...
export default async function PreliminaryReportDetailPage({ params }: Props) {
  ...
  return (
    <main className="min-h-screen bg-black px-4 py-10 text-white sm:px-6 lg:px-8"><div className="mx-auto max-w-6xl">
      ...
      <PreliminaryReportActionPanel key={`${report.reportStatus}-${report.currentVersion}`} reportId={report.reportId} status={report.reportStatus} currentVersion={report.currentVersion} initialContent={report.currentContent} />
