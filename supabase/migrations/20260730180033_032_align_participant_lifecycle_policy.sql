...
-- Migration: 032_align_participant_lifecycle_policy
-- Purpose:
-- Align the authoritative participant lifecycle transition function with the
-- approved institutional lifecycle policy.
-- ============================================================================
